...
bubbleBox.addEventListener('click', function (e) {
  ...
  // ===== 桌宠定制三态：余额 → 峰谷 → 台词（必定） → 关闭 =====
  if (bubbleStage >= 3) {
    hideBubble()
  } else if (bubbleStage === 2) {
    bubbleStage = 3
    ...
    bubbleStage = 1
    swapBubbleContent(function () { applyBubbleLines(buildBalanceLines()) })
  }
})
...
function isWhaleHit(e) {
  try { window.__whaleDiag = { isWhaleHit: function (ev) { return isWhaleHit(ev) }, get hitReady() { return hitReady } } } catch (e) {}
